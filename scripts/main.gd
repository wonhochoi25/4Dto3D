...
const Editor = preload("res://scripts/geometry/geometry_editor.gd")
const Renderer = preload("res://scripts/rendering/shape_renderer.gd")
const ProjectionPanel = preload("res://scripts/ui/projection_panel.gd")
const VertexPanel = preload("res://scripts/ui/vertex_editor_panel.gd")
