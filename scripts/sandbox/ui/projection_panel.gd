extends "res://scripts/sandbox/ui/collapsible_panel.gd"
...
const Settings = preload("res://scripts/sandbox/ui/ui_settings.gd")
...
func _ready() -> void:
	...
	transform_panel = preload("res://scripts/sandbox/ui/transform_panel.gd").new()
